...
export class DashboardEntityComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getAllTracedSummary(this.userInfo.userid, "0");
    this.getMostContactTraced(this.userInfo.userid, "0");
    this.getMostExposedLocation(this.userInfo.userid, "0");
  }
  ...
  getMostContactTraced(entityId = "0", stateId = "0") {
    ...
    this.context
      .getWithToken(
        "",
        "trace/getdashboardmostcontacttraced/" + entityId + "/" + stateId
      )
      .subscribe((data) => {
        let d = <any>data;
  ...
  getMostExposedLocation(entityId = "0", stateId = "0") {
    ...
    this.context
      .getWithToken(
        "",
        "trace/getdashboardmostexposedlocation/" + entityId + "/" + stateId
      )
      .subscribe((data) => {
        let d = <any>data;
  ...
  lineChartData: ChartDataSets[] = [
    {
      data: [85, 72, 78, 75, 77, 75, 2, 22, 100, 0, 11, 45],
      label: "Visitations",
    },
  ];
