...
@Component({
  selector: 'app-view-all-entities',
  templateUrl: './view-all-entities.component.html',
  styleUrls: ['./view-all-entities.component.css']
})
export class ViewAllEntitiesComponent implements OnInit {
  ...
  getAllTableList(id="0"){
    this.utils.StartSpinner();
      this.context.getWithToken('','location/getuserlocationcounts').
      subscribe( data => {
        let d = <any>data;
